...
module.exports = {
    ...
    async execute(interaction) {
        ...
        console.log(`Command: ${interaction.commandName}, Ran by: ${interaction.user.tag}, Message: ${message}, Time: ${date.toLocaleString('en-US', { timeZone: 'America/Toronto', dateStyle: 'full', timeStyle: 'full' })}`); //11 seconds behind but idc
    },
};